...
@section('contenido')
  @parent
    <div class="page-content">
		...
		@include('reportes.detallepagos')
		<div class="row">
			<div class="col-sm-9">
			<div class="btn-group btn-corner pull-right">
				<a href="/main/pagos/{{ $fecha }}/imprimir" target="_blank" class="btn btn-info pull-right"><i class="fa fa-print"></i></a>
			</div>
			</div>
		</div>
@endsection
